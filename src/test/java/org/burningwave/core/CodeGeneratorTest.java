...
public class CodeGeneratorTest extends BaseTest {
	...
	public void generateUnitTestOne() throws Throwable {
		testDoesNotThrow(() -> {
			...
			unit.addClass(Class.createEnum(TypeDeclaration.create("MyEnum")).addField(Variable.create((TypeDeclaration)null, "FIRST_VALUE")).addField(Variable.create((TypeDeclaration)null, "SECOND_VALUE")));
