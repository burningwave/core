...
public class PathHelperTest extends BaseTest {
	...
	public void getResourceAsStreamTestOne() {
		testNotNull(() ->{ 
			...
			try(InputStream inputStream = componentSupplier.getPathHelper().getResourceAsStream("io/github/toolfactory/jvm/function/catalog/ClassLoaderDelegateForJDK9.bwc")) {
				return inputStream;
			}
		});
	}
