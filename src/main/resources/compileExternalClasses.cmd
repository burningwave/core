...
del %~dp0org\burningwave\core\jvm\AccessibleSetterRetrieverForJDK9.bwc
del %~dp0org\burningwave\core\jvm\ConsulterRetrieverForJDK9.bwc
call %JAVA_HOME%\bin\javac.exe -cp "%~dp0..\..\..\target\classes;%~dp0;" --release 9 %~dp0jdk\internal\loader\ClassLoaderDelegateForJDK9.java
call %JAVA_HOME%\bin\javac.exe -cp "%~dp0..\..\..\target\classes;%~dp0;" --release 8 %~dp0java\lang\reflect\AccessibleSetterRetrieverForJDK9.java
...
move %~dp0java\lang\reflect\AccessibleSetterRetrieverForJDK9.class %~dp0org\burningwave\core\jvm\AccessibleSetterRetrieverForJDK9.bwc
