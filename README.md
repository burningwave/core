...
By using the **BackgroundExecutor** component you can launch different functional interfaces in parallel **by setting the priority of the thread they will be assinghed to**. There is also the option to wait for them start or finish.
