...
**Tested on Java versions ranging from 8 to 14, Burningwave Core is also useful for creating classes during runtime, to facilitate the use of reflection, to scan the filesytem, to execute stringified code and much more...**
