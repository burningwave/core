...
**Tested on Java versions ranging from 8 to 14, Burningwave Core is useful for scanning multiple class paths, generating classes at runtime, facilitating the use of reflection, scanning the filesystem, executing stringified code and much more...**
