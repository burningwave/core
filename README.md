Burningwave Core [![Tweet](https://img.shields.io/twitter/url/http/shields.io.svg?style=social)](https://twitter.com/intent/tweet?text=%40Burningwave1%20Core%3A%20a%20%23Java%20frameworks%20building%20library%3B%20it%27s%20useful%20for%20scanning%20class%20paths%2C%20generating%20classes%20at%20runtime%2C%20facilitating%20the%20use%20of%20reflection%2C%20scanning%20the%20filesystem%2C%20executing%20stringified%20code%20and%20much%20more...%20&url=https://github.com/burningwave/core)
==========
...
[![Supported JVM](https://img.shields.io/badge/Supported%20JVM-8%2C%209%2C%2010%2C%2011%2C%2012%2C%2013%2C%2014%2C%2015ea-green)](https://github.com/burningwave/core/actions/runs/104801538)
...
**Tested on Java versions ranging from 8 to 15-ea, Burningwave Core**, is a completely independent, advanced, free and open source Java library with which to build frameworks; It is useful for scanning class paths, generating classes at run time, facilitating the use of reflection, scanning the filesystem, executing stringed code and much more...
...
<details>
	...
	<pre>implementation 'org.burningwave:core:5.17.0'</pre>
	<br/>
	<ul><li><b>Gradle Kotlin</b>:</li></ul>
	<pre>implementation("org.burningwave:core:5.17.0")</pre>
	<br/>
	<ul><li><b>Scala</b>:</li></ul>
	<pre>libraryDependencies += "org.burningwave" % "core" % "5.17.0"</pre>
	<br/>
	<ul><li><b>Apache Ivy</b>:</li></ul>
	<pre>&lt;dependency org="org.burningwave" name="core" rev="5.17.0" /&gt;</pre>
	<br/>
	<ul><li><b>Groovy Grape</b>:</li></ul>
	<pre>
@Grapes(
  	@Grab(group='org.burningwave', module='core', version='5.17.0')
)
	</pre>
	<br/>
	<ul><li><b>Leiningen</b>:</li></ul>
	<pre>[org.burningwave/core "5.17.0"]</pre>
	<br/>
	<ul><li><b>Apache Buildr</b>:</li></ul>
	<pre>'org.burningwave:core:jar:5.17.0'</pre>
	<br/>
	<ul><li><b>PURL</b>:</li></ul>
	<pre>pkg:maven/org.burningwave/core@5.17.0</pre>
</details>
